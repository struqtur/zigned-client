...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AgreementsGetResponse200DataItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Vendor\\Library\\Generated\\Model\\AgreementsGetResponse200DataItem';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Vendor\\Library\\Generated\\Model\\AgreementsGetResponse200DataItem';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Vendor\Library\Generated\Model\AgreementsGetResponse200DataItem();
            ...
            if (\array_key_exists('issuer', $data)) {
                $object->setIssuer($this->denormalizer->denormalize($data['issuer'], 'Vendor\\Library\\Generated\\Model\\AgreementsGetResponse200DataItemIssuer', 'json', $context));
                unset($data['issuer']);
            }
            ...
            if (\array_key_exists('documents', $data)) {
                $object->setDocuments($this->denormalizer->denormalize($data['documents'], 'Vendor\\Library\\Generated\\Model\\AgreementsGetResponse200DataItemDocuments', 'json', $context));
                unset($data['documents']);
            }
            if (\array_key_exists('signing_order', $data)) {
                $object->setSigningOrder($this->denormalizer->denormalize($data['signing_order'], 'Vendor\\Library\\Generated\\Model\\AgreementsGetResponse200DataItemSigningOrder', 'json', $context));
                unset($data['signing_order']);
            }
            if (\array_key_exists('communication', $data)) {
                $object->setCommunication($this->denormalizer->denormalize($data['communication'], 'Vendor\\Library\\Generated\\Model\\AgreementsGetResponse200DataItemCommunication', 'json', $context));
                unset($data['communication']);
            }
            if (\array_key_exists('metadata', $data)) {
                $object->setMetadata($this->denormalizer->denormalize($data['metadata'], 'Vendor\\Library\\Generated\\Model\\AgreementsGetResponse200DataItemMetadata', 'json', $context));
                unset($data['metadata']);
            }
        ...
        {
            return ['Vendor\\Library\\Generated\\Model\\AgreementsGetResponse200DataItem' => false];
        }
    }
} else {
    class AgreementsGetResponse200DataItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
