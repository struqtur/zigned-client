...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AgreementsAgreementIdDocumentsMainPostResponse200DataDocumentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdDocumentsMainPostResponse200DataDocuments';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdDocumentsMainPostResponse200DataDocuments';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Struqtur\Zigned\Api\Model\AgreementsAgreementIdDocumentsMainPostResponse200DataDocuments();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('original_documents', $data)) {
                $object->setOriginalDocuments($this->denormalizer->denormalize($data['original_documents'], 'Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdDocumentsMainPostResponse200DataDocumentsOriginalDocuments', 'json', $context));
        ...
        {
            return ['Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdDocumentsMainPostResponse200DataDocuments' => false];
        }
    }
} else {
    class AgreementsAgreementIdDocumentsMainPostResponse200DataDocumentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
