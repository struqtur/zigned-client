...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ThemesPostResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Struqtur\\Zigned\\Api\\Model\\ThemesPostResponse200Data';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Struqtur\\Zigned\\Api\\Model\\ThemesPostResponse200Data';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Struqtur\Zigned\Api\Model\ThemesPostResponse200Data();
            ...
            if (\array_key_exists('logo', $data)) {
                $object->setLogo($this->denormalizer->denormalize($data['logo'], 'Struqtur\\Zigned\\Api\\Model\\ThemesPostResponse200DataLogo', 'json', $context));
                unset($data['logo']);
            }
            if (\array_key_exists('icon', $data)) {
                $object->setIcon($this->denormalizer->denormalize($data['icon'], 'Struqtur\\Zigned\\Api\\Model\\ThemesPostResponse200DataIcon', 'json', $context));
                unset($data['icon']);
            }
            ...
            if (\array_key_exists('metadata', $data)) {
                $object->setMetadata($this->denormalizer->denormalize($data['metadata'], 'Struqtur\\Zigned\\Api\\Model\\ThemesPostResponse200DataMetadata', 'json', $context));
                unset($data['metadata']);
            }
        ...
        {
            return ['Struqtur\\Zigned\\Api\\Model\\ThemesPostResponse200Data' => false];
        }
    }
} else {
    class ThemesPostResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
