...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AgreementsPostResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Struqtur\\Zigned\\Api\\Model\\AgreementsPostResponse200Data';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Struqtur\\Zigned\\Api\\Model\\AgreementsPostResponse200Data';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Struqtur\Zigned\Api\Model\AgreementsPostResponse200Data();
            ...
            if (\array_key_exists('issuer', $data)) {
                $object->setIssuer($this->denormalizer->denormalize($data['issuer'], 'Struqtur\\Zigned\\Api\\Model\\AgreementsPostResponse200DataIssuer', 'json', $context));
                unset($data['issuer']);
            }
            ...
            if (\array_key_exists('documents', $data)) {
                $object->setDocuments($this->denormalizer->denormalize($data['documents'], 'Struqtur\\Zigned\\Api\\Model\\AgreementsPostResponse200DataDocuments', 'json', $context));
                unset($data['documents']);
            }
            if (\array_key_exists('signing_order', $data)) {
                $object->setSigningOrder($this->denormalizer->denormalize($data['signing_order'], 'Struqtur\\Zigned\\Api\\Model\\AgreementsPostResponse200DataSigningOrder', 'json', $context));
                unset($data['signing_order']);
            }
            if (\array_key_exists('communication', $data)) {
                $object->setCommunication($this->denormalizer->denormalize($data['communication'], 'Struqtur\\Zigned\\Api\\Model\\AgreementsPostResponse200DataCommunication', 'json', $context));
                unset($data['communication']);
            }
            if (\array_key_exists('metadata', $data)) {
                $object->setMetadata($this->denormalizer->denormalize($data['metadata'], 'Struqtur\\Zigned\\Api\\Model\\AgreementsPostResponse200DataMetadata', 'json', $context));
                unset($data['metadata']);
            }
        ...
        {
            return ['Struqtur\\Zigned\\Api\\Model\\AgreementsPostResponse200Data' => false];
        }
    }
} else {
    class AgreementsPostResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
