...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class D69cfbd1e408327b80080ee78c087563df3370f4ItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Struqtur\\Zigned\\Api\\Model\\D69cfbd1e408327b80080ee78c087563df3370f4Item';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Struqtur\\Zigned\\Api\\Model\\D69cfbd1e408327b80080ee78c087563df3370f4Item';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Struqtur\Zigned\Api\Model\D69cfbd1e408327b80080ee78c087563df3370f4Item();
        ...
        {
            return ['Struqtur\\Zigned\\Api\\Model\\D69cfbd1e408327b80080ee78c087563df3370f4Item' => false];
        }
    }
} else {
    class D69cfbd1e408327b80080ee78c087563df3370f4ItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
