...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AgreementsAgreementIdPutResponse200DataDocumentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdPutResponse200DataDocuments';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdPutResponse200DataDocuments';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Struqtur\Zigned\Api\Model\AgreementsAgreementIdPutResponse200DataDocuments();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('original_documents', $data)) {
                $object->setOriginalDocuments($this->denormalizer->denormalize($data['original_documents'], 'Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdPutResponse200DataDocumentsOriginalDocuments', 'json', $context));
        ...
        {
            return ['Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdPutResponse200DataDocuments' => false];
        }
    }
} else {
    class AgreementsAgreementIdPutResponse200DataDocumentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
