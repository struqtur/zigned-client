...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AgreementsAgreementIdPutResponse200DataIssuerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdPutResponse200DataIssuer';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdPutResponse200DataIssuer';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Struqtur\Zigned\Api\Model\AgreementsAgreementIdPutResponse200DataIssuer();
        ...
        {
            return ['Struqtur\\Zigned\\Api\\Model\\AgreementsAgreementIdPutResponse200DataIssuer' => false];
        }
    }
} else {
    class AgreementsAgreementIdPutResponse200DataIssuerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
