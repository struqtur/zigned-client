...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AgreementsAgreementIdParticipantsPostResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Struqtur\\Zigned\\Model\\AgreementsAgreementIdParticipantsPostResponse200Data';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Struqtur\\Zigned\\Model\\AgreementsAgreementIdParticipantsPostResponse200Data';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Struqtur\Zigned\Model\AgreementsAgreementIdParticipantsPostResponse200Data();
        ...
        {
            return ['Struqtur\\Zigned\\Model\\AgreementsAgreementIdParticipantsPostResponse200Data' => false];
        }
    }
} else {
    class AgreementsAgreementIdParticipantsPostResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
