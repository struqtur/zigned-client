...
class PutAgreementsAgreementIdParticipantsParticipantId extends \Struqtur\Zigned\Runtime\Client\BaseEndpoint implements \Struqtur\Zigned\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $agreementId, string $participantId, ?\Struqtur\Zigned\Model\AgreementsAgreementIdParticipantsParticipantIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Struqtur\Zigned\Model\AgreementsAgreementIdParticipantsParticipantIdPutBody) {
     ...
     *
     * @return null|\Struqtur\Zigned\Model\AgreementsAgreementIdParticipantsParticipantIdPutResponse200
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'Struqtur\\Zigned\\Model\\AgreementsAgreementIdParticipantsParticipantIdPutResponse200', 'json');
        }
        if (is_null($contentType) === false && (400 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            throw new \Struqtur\Zigned\Exception\PutAgreementsAgreementIdParticipantsParticipantIdBadRequestException($serializer->deserialize($body, 'Struqtur\\Zigned\\Model\\AgreementsAgreementIdParticipantsParticipantIdPutResponse400', 'json'), $response);
        }
    }
