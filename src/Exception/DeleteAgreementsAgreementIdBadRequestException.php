...
{
    /**
     * @var \Struqtur\Zigned\Model\AgreementsAgreementIdDeleteResponse400
     */
     ...
     */
    private $response;
    public function __construct(\Struqtur\Zigned\Model\AgreementsAgreementIdDeleteResponse400 $agreementsAgreementIdDeleteResponse400, \Psr\Http\Message\ResponseInterface $response)
    {
    ...
    public function getAgreementsAgreementIdDeleteResponse400() : \Struqtur\Zigned\Model\AgreementsAgreementIdDeleteResponse400
    {
