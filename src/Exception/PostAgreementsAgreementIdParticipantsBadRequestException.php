...
{
    /**
     * @var \Struqtur\Zigned\Api\Model\AgreementsAgreementIdParticipantsPostResponse400
     */
     ...
     */
    private $response;
    public function __construct(\Struqtur\Zigned\Api\Model\AgreementsAgreementIdParticipantsPostResponse400 $agreementsAgreementIdParticipantsPostResponse400, \Psr\Http\Message\ResponseInterface $response)
    {
    ...
    public function getAgreementsAgreementIdParticipantsPostResponse400() : \Struqtur\Zigned\Api\Model\AgreementsAgreementIdParticipantsPostResponse400
    {
