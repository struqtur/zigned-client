...
{
    /**
     * @var \Struqtur\Zigned\Model\AgreementsAgreementIdParticipantsParticipantIdDeleteResponse400
     */
     ...
     */
    private $response;
    public function __construct(\Struqtur\Zigned\Model\AgreementsAgreementIdParticipantsParticipantIdDeleteResponse400 $agreementsAgreementIdParticipantsParticipantIdDeleteResponse400, \Psr\Http\Message\ResponseInterface $response)
    {
    ...
    public function getAgreementsAgreementIdParticipantsParticipantIdDeleteResponse400() : \Struqtur\Zigned\Model\AgreementsAgreementIdParticipantsParticipantIdDeleteResponse400
    {
