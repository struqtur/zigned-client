...
{
    /**
     * @var \Struqtur\Zigned\Model\AgreementsAgreementIdDocumentsAttachmentsGetResponse400
     */
     ...
     */
    private $response;
    public function __construct(\Struqtur\Zigned\Model\AgreementsAgreementIdDocumentsAttachmentsGetResponse400 $agreementsAgreementIdDocumentsAttachmentsGetResponse400, \Psr\Http\Message\ResponseInterface $response)
    {
    ...
    public function getAgreementsAgreementIdDocumentsAttachmentsGetResponse400() : \Struqtur\Zigned\Model\AgreementsAgreementIdDocumentsAttachmentsGetResponse400
    {
